---
title: Tailwind, or, Smashing the Sacred Tenets of CSS
summary: Upending the orthodoxy of CSS
tags:  [ CSS3, Code ]
...
Tailwind CSS is an "opinionated"\* framework, which means it's not just a
pile of semantic, conceptual classes. It makes some atomic (small)
design decisions for you, and nudges the page author in a direction
towards hopefully good-looking components and pages.
